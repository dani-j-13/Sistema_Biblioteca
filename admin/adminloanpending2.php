...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <br><br><br>
        <div class="container-fluid">
            <p class="lead text-center">Buscar por Código Libro o DNI</p>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-4">
                                    <div class="group-material">
                                        <input type="search" class="material-control tooltips-general" placeholder="Código Libro o DNI" name="ukeyl" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el Código Libro o DNI">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-4">
                                    <div class="group-material">
            ...
            if($utypel==4){
                while($data=mysqli_fetch_array($checkLoansPending, MYSQLI_ASSOC)){
                    ...
                    if(mysqli_num_rows($checkLoanU2)>=1){
                        ...
                        $selectStudentData=ejecutarSQL::consultar("SELECT * FROM estudiante WHERE DNI='".$dataU2['DNI']."'");
