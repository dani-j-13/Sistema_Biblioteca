    ...
    <div class="content-page-container full-reset scroll">
        ...
        <div class="container-fluid" style="margin: 0 0 50px 0;">
            <form class="pull-right" style="width: 30% !important;" action="adminliststudent.php" method="get" autocomplete="off">
                <div class="group-material">
                    <input type="search" style="display: inline-block !important; width: 70%;" class="material-control tooltips-general" placeholder="Buscar estudiante" name="StudentN" required="" data-toggle="tooltip" data-placement="top" title="Escribe los nombres, apellidos o DNI del estudiante">
        ...
        <div class="container-fluid">
            ...
            <?php
                ...
                if(!$StudentN==""){
                    $selectStudentByName=ejecutarSQL::consultar("SELECT * FROM estudiante WHERE Nombre LIKE '%".$StudentN."%' OR DNI LIKE '%".$StudentN."%' OR Apellido LIKE '%".$StudentN."%' ORDER BY Apellido ASC, Nombre ASC");
                    if(mysqli_num_rows($selectStudentByName)>0){
                                ...
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            ...
                                            <div class="div-table-cell" style="width: 18%;">'.$dataSN['DNI'].'</div>
                                            ...
                                            <div class="div-table-cell" style="width: 9%;"><button class="btn btn-success btn-update" data-code="'.$dataSN['DNI'].'" data-url="../process/SelectDataStudent.php"><i class="zmdi zmdi-refresh"></i></button></div>
                                            <form class="div-table-cell form_SRCB" action="../process/DeleteStudent.php" method="post" data-type-form="delete" style="width: 9%;">
                                                <input value="'.$dataSN['DNI'].'" type="hidden" name="primaryKey">
                        ...
                        echo '<br><br><br><h3 class="text-center all-tittles">No existe ningún estudiante registrado con los nombres, apellidos o DNI "'.$StudentN.'"</h3><br><br>';
                    }
                            ...
                            echo '<li>
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            <div class="div-table-cell" style="width: 6%;">'.$c.'</div>
                                            <div class="div-table-cell" style="width: 18%;">'.$dataSS['DNI'].'</div>
                                            ...
                                            <div class="div-table-cell" style="width: 9%;"><button class="btn btn-success btn-update" data-code="'.$dataSS['DNI'].'" data-url="../process/SelectDataStudent.php"><i class="zmdi zmdi-refresh"></i></button></div>
                                            <form class="div-table-cell form_SRCB" action="../process/DeleteStudent.php" method="post" data-type-form="delete" style="width: 9%;">
                                                <input value="'.$dataSS['DNI'].'" type="hidden" name="primaryKey">
                                                <button type="submit" class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button>
                                            </form>
                                        </div>
                                    </div>
