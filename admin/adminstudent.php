                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           ...
                           <legend>Datos del estudiante</legend><br>
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el DNI del alumno" name="studentDNI" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="DNI de estudiante">
