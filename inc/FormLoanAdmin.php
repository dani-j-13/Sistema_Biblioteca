                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <form action="process/AddLoanStudent.php" method="post" class="form_SRCB" data-type-form="saveLoan" autocomplete="off">
                                ...
                                <div class="search-box">
                                    <i class="zmdi zmdi-search search-box-icon tooltips-general" data-toggle="tooltip" data-placement="top" title="Haz clic aquí para buscar el DNI del estudiante" data-id="formStudents"></i>
                                ...
                                <div class="group-material">
                                    <input type="text" class="material-control tooltips-general" id="inputStudents" placeholder="Escribe aquí el DNI del alumno" name="userKey" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="DNI de estudiante">
