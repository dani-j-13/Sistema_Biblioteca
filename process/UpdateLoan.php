    ...
    if($CountErrors>=1){
        echo '<script type="text/javascript">
            swal({ 
                ...
                text:"Tuvimos algunos problemas al realizar la operación solicitada, puede ser que algunos préstamos no se marcaron con entregados, por favor intenta nuevamente", 
                type: "error", 
        ...
        echo '<script type="text/javascript">
            swal({ 
                ...
                text:"Los préstamos ahora aparecerán como entregados", 
                type: "success", 
                confirmButtonText: "Aceptar" 
            },
            function(isConfirm){  
