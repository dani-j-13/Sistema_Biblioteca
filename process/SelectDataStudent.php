...
$selectStudent=ejecutarSQL::consultar("SELECT * FROM estudiante WHERE DNI='".$codeStudent."'");
...
if(mysqli_num_rows($selectStudent)>=1){
    ...
    <input type="hidden" value="'.$dataStudent['DNI'].'" name="studentDNIOld">
    <div class="group-material">
        <input type="text" class="material-control tooltips-general" value="'.$dataStudent['DNI'].'" name="studentDNI" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="DNI de estudiante">
